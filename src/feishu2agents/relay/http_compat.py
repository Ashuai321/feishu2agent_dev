...
DEBUG_LOGGER = logging.getLogger("feishu2agents.relay.mcp_debug")
...
def _resolve_version(app_name: str) -> str:
    try:
        ...
        # The relay is vendored inside feishu2agents, so its original
        # distribution name is no longer installed separately.
        try:
            return package_version("feishu2agents")
        except PackageNotFoundError:
            return "0.0.0"
